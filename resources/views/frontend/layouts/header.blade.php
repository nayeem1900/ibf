                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{route('ibchmanikgonj')}}">Islami Bank Community Hospital,Manikgong Ltd</a></li>
                                ...
                                <li><a class="dropdown-item" href="#">Islami Bank Nursing Institute Barisal</a></li>
