...
<main id="main">
                        ...
                        <div class="row">
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <p>Islami Bank Hospital, Motijheel provide emergency ambulance service in Dhaka.</p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    <i class="bx bx-cube-alt"></i>
                                    <h4>Gastroenterology Centre</h4>
                                    <p>Every patient is unique.Islami Bank Hospital of Gastroenterologists and Hepatologists with national and international training, qualification and experience ensures that you are treated specially, individually, uniquely. </p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <p>Islami Bank Hospital Laboratory concentration on best quality patient care services.The proper & timely reporting plays an important role in corroborative medical decisions for the best patient attention. </p>
                                </div>
                            </div>
                            <!--customized---->
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    <i class="bx bx-images"></i>
                                    <h4>Covid-19</h4>
                                    <p>Islami Bank Hospital special care for covit-19 patient </p>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                    <h3>Why Choose Us</h3>
                    <p>Our team of doctors, advanced care providers, nurses, therapists and researchers provide the region's most advanced medicine at multiple facilities, campuses, clinics and classrooms. We offer patients convenient access to innovative treatments and advancements that improve the health and overall wellbeing of our community.</p>
    ...
    <section id="departments" class="departments">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Departments</h2>
                <p>There are several departments have in Islami Bank hospital, Motijheel namely Outpatient department (OPD), Medical Department, Nursing Department,Physical Medicine and Rehabilitation Department, Operation Theatre Complex (OT), Pharmacy Department, Radiology Department (X-ray).</p>
            </div>
                    ...
                    <div class="info">
                        <div class="address">
                            ...
                            <p>24 / B, Outer Circular Road, Motijheel, Dhaka-1000
                                Phone:02 – 58311740,02 – 58312372, 01981415403</p>
                        </div>

                        <div class="email">
                            <i class="bi bi-envelope"></i>
                            <h4>Email:</h4>
                            <p>ibhdhaka@gmail.com</p>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    <h3>Islami Bank Hospital Motijheel</h3>
                    <p>
                        Islmi Bank Hospital, Motijheel <br>
                        24 / B, Outer Circular Road <br>
                        Motijheel, Dhaka-1000 <br><br>
                        <strong>Phone:</strong> 02 – 58311740<br>
                        <strong>Email:</strong> ibhdhaka@gmail.com<br>
                    </p>
                </div>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Our Services</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Accident & Emergency</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Gynaecology & Obstetrics</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#"> Gastroenterology</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Dental Surgery</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Laboratory Medicine</a></li>
                    </ul>
                </div>
